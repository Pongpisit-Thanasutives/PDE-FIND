...
denoise = 1;
in_fname = 'kuramoto_sivishinky30';
if denoise
    in_fname = 'kuramoto_sivishinky30_ksvdreg';
end
% in_fname = 'kuramoto_sivishinky'; % ground
dr = ['inputs/KS/', append(in_fname, '.mat')];
...
if ~use_presets
    ...
    tauhat = 5;      %%% if tauhat<=0, explicit vals for m_x,m_t,p_x,p_t used. 
    tau = 10^-6;
...
filename = append("./outputs/KS/", append(in_fname, '_outputs.mat'));
save(filename);
% display_results;