...
pde_num = 1;
pde_names = {'burgers_shock.mat','burgers.mat','KdV.mat','KS.mat','NLS.mat','Sine_Gordon.mat','rxn_diff.mat','Nav_Stokes.mat','porous.mat','sod.mat'};
dr = ['datasets/',pde_names{pde_num}];
% dr = ['/home/danielmessenger/Dropbox/Boulder/research/data/WSINDy_PDE/datasets/',pde_names{pde_num}];

% % Comparing with WeakSINDy
% dr = ['datasets/burgers_shock.mat'];
dr = ['datasets/burgers_shock_noiselv1.mat'];
% dr = ['datasets/KdV_simple2.mat'];
% dr = ['datasets/KdV_simple2_noiselv1.mat'];
% dr = ['datasets/kura.mat'];
% dr = ['datasets/kura_noiselv1.mat'];

% % IPI + WeakSINDy
% dr = ['datasets/burgers_shock_IPI_cleanall.mat'];
% dr = ['datasets/burgers_shock_IPI_noisy1.mat'];
% dr = ['datasets/burgers_shock_IPI_noisy2.mat'];

% dr = ['datasets/KdV_simple2_IPI_cleanall.mat'];
% dr = ['datasets/KdV_simple2_IPI_noisy1.mat'];
% dr = ['datasets/KdV_simple2_IPI_noisy2.mat'];

% dr = ['datasets/kura_IPI_cleanall.mat'];
% dr = ['datasets/kura_IPI_noisy1.mat'];
% dr = ['datasets/kura_IPI_noisy2.mat'];
...
coarsen_data(1,:) = [0 issub max_spatial];  % every (middle number) point in x
coarsen_data(2,:) = [0.0 issub max_temporal]; % every (middle number) point in t
